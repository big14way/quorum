...
- Ground truth: discriminators, base58 constants, and PDA vectors were
  generated by an independent pure-Python implementation; a mainnet fixture
  test pinning the encoders to a proposal created by the official Squads app
  is in the suite.
  <!-- update the line above once the fixture test lands -->
